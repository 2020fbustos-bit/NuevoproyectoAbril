    ...
    <div className="relative min-h-screen pb-24 font-sans px-4">
      ...
      {players.length === 0 ? (
        ...
        <div className="space-y-3">
          {players.map(player => (
            <div key={player.id} className="bg-surface hover:bg-surface/80 transition-colors rounded-xl p-4 flex items-center shadow-md cursor-pointer group">
              ...
              <button className="px-3 py-1.5 bg-primary text-background font-bold text-[10px] uppercase rounded-md shadow-sm opacity-90 group-hover:opacity-100 transition-opacity">
                Ver Ficha
              </button>
            </div>
          ))}
